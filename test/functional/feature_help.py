...
"""Verify that starting doraecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start doraecoin with -h for help text")
        ...
        self.log.info("Start doraecoin with -version for version information")
        ...
        self.log.info("Start doraecoind with -fakearg to make sure it does not start")
