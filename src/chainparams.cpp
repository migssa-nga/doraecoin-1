...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 0.01 * 60;
        ...
        //vSeeds.emplace_back("seed-a.doraecoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.doraecointools.com");
        //vSeeds.emplace_back("dnsseed.doraecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.doraecointools.com");
        vSeeds.emplace_back("seed-b.doraecoin.loshan.co.uk");
