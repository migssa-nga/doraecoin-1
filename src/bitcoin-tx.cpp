...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " doraecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  doraecoin-tx [options] <hex-tx> [commands]  Update hex-encoded doraecoin transaction\n" +
            "or:     doraecoin-tx [options] -create [commands]   Create hex-encoded doraecoin transaction\n" +
            "\n";
